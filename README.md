...
- The headline favorite-downgrade exhibit shows only each tournament's highest-ranked non-CCS team. The broader Top-12 non-CCS audit list is retained in `data/derived/favorite_traps.csv`.
